...
# print(s[::])  # Идём от первого до последнего элемента с шагом 1. -  Hello,my studdy page!
# print(s[2::])  # Хотим начать со второго индекса. - llo,my studdy page!
# print(s[::2]) # Хотим пойти с шагом через 1. - Hlom tdypg!
#
# #У срезов есть ещё одна интересная возможность — идти не от начала, а от конца, добавив знак "-".
# print(s[-1]) # Хотим начать от последнего элемента. !
# print(s[:-2]) # Хотим вывести все элементы кроме двух последних. Hello,my studdy pag
# print(s[::-1]) # Хотим вывести элементы не с шагом 1, а в обратном порядке с шагом -1. !egap ydduts ym,olleH
                                    #Соединение строк
