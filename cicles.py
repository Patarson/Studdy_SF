                                        # Циклы
# Цикл — это последовательность инструкций, которая повторяется до тех пор, пока не будет достигнуто определённое условие.
                                # Код, который исполняется многократно — это тело цикла.
            # Каждый проход тела цикла называется итерацией.
...
# #     print(k, v) # Выводим значения в терминал
...
#         break
                ...
                # Сокращённый цикл for .. in .. используется для создания новых последовательностей
                        # Пример 1
...
#Словарь на основании списка.Функция enumerate()возвращает индекс элемента и можно этот индекс присвоить ключу.
#
# print(scores)
